...
// data-page values: home, docs, tutorial, shortcuts, watch, transfer, agency, faq, support, privacy, terms
    ...
    nav.innerHTML = `
        <div class="nav-inner">
            ...
            <div class="nav-links" id="nav-links-list">
                ...
                <a href="support.html"  data-nav="support">Sponsor</a>
